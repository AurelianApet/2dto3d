...
namespace OpenCVForUnityExample
{
    ...
    public class GrabCutExample : MonoBehaviour
    {
        ...
        void Start ()
        {
            //Texture2D imageTexture = Resources.Load ("origin") as Texture2D;
            Texture2D imageTexture = Resources.Load("test") as Texture2D;
            ...
            Texture2D maskTexture = Resources.Load ("1") as Texture2D;
            //Texture2D maskTexture = Resources.Load("lena_grabcut_mask - Copy1") as Texture2D;
